...
\vskip .2in
\centerline{ Fall 2018 }
\vskip .5in
\document

\underbar{{\bf Note:}}\quad  {\bf Do}  but don't turn in yet the problems followed by an asterisk $*$. 
%\underbar{Special Projects} nor
\vskip .3in


\subhead{ Assignment 1.   Due  Thursday 09/27/2018 }\endsubhead
 \vskip .2in 
...
\underbar{Additional Problem 1$^\ast$:}  \quad Show that $(\IC, + , \cdot)$ as defined
in class is a field.   
...
\subhead{ Assignment 3.  Due Thursday 10/11/2018}\endsubhead
...
\subhead{ Assignment 4.  Due Thursday 10/25/2018}\endsubhead
...
hypothesis.  
\vskip .07in
( Note: the general case is posted as a Handout.).
...
\subhead{ Assignment 5.   Due Thursday 11/08/18}\endsubhead
...
\subhead{ Assignment 7.  Due Thursday  12/06/2018}\endsubhead
\vskip .1in 
