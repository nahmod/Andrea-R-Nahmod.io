...
\head { SET 6:  Problems to do before Final Exam--Do not turn in}\endhead
\vskip .1in
...
\underbar{Further Reading Suggestions:}   Besides your class notes on Ch. 6,  you may want to read:

\vskip .1in 

From \underbar{Folland:}

\vskip .1in

(1)\,   Section 6.1 (all), Prop. 6.17 in Section 6.3, Propositions 6.22, 6.23 and 6.24 in Section 6.4  
\vskip .1in 
